...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    InAuction: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    MinBid: Attribute.Decimal & Attribute.DefaultTo<5>;
    DateAdded: Attribute.Date & Attribute.Required;
    PrimaryImage: Attribute.Media & Attribute.Required;
